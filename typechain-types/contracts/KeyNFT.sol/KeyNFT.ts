...
export interface KeyNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "MINTER_ROLE"
...
export interface KeyNFT extends BaseContract {
  connect(runner?: ContractRunner | null): KeyNFT;
  waitForDeployment(): Promise<this>;

  interface: KeyNFTInterface;
