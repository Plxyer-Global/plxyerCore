...
export interface PriceOracleInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "PRICE_SETTER",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "SUPPORTED_CURRENCY",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface PriceOracle extends BaseContract {
  ...
  PRICE_SETTER: TypedContractMethod<[], [string], "view">;

  SUPPORTED_CURRENCY: TypedContractMethod<[], [string], "view">;

  getRoleAdmin: TypedContractMethod<[role: BytesLike], [string], "view">;

  getTokenAmount: TypedContractMethod<
    [amountUSD: BigNumberish, tokenAddress: AddressLike],
    [bigint],
    "view"
  >;
  ...
  getFunction(
    nameOrSignature: "PRICE_SETTER"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
    nameOrSignature: "SUPPORTED_CURRENCY"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
